...
public class MonstroView extends JPanel {
    ...
    public MonstroView(Gerenciador gerenciador) {
        ...
        estilizarComboBox(cbxSelecionar);
        ...
        tblLoot.setShowVerticalLines(false);
        ...
        btnSalvar = new JButtonCustom("Salvar Monstro", FontIcon.of(FontAwesomeSolid.SAVE, 12, AppColors.PARCHMENT));
        ...
        // Selecionar Monstro
        gbc.gridy = 2; gbc.gridwidth = 1; gbc.weightx = 0.25; gbc.insets = new Insets(0, 0, 0, 5);
        this.add(lblSelecionar, gbc);
        gbc.gridx = 1; gbc.gridwidth = 3; gbc.weightx = 0.75; gbc.insets = new Insets(0, 5, 0, 0);
        this.add(cbxSelecionar, gbc);

        // Espaçador
        gbc.gridx = 0; gbc.gridy = 3; gbc.gridwidth = 4; gbc.insets = new Insets(10, 0, 10, 0);
        JSeparator sepDiv = new JSeparator();
        sepDiv.setForeground(AppColors.GOLD); sepDiv.setBackground(AppColors.GOLD);
        this.add(sepDiv, gbc);

        // Atributos (Linha 1) - Nome
        gbc.insets = new Insets(0, 0, 6, 5);
        gbc.gridy = 4; gbc.gridx = 0; gbc.gridwidth = 1;
        this.add(lblNome, gbc);
        gbc.gridx = 1; gbc.gridwidth = 3; gbc.insets = new Insets(0, 5, 6, 0);
        this.add(txtNome, gbc);

        // Atributos (Linha 2) - Nivel e Vida
        gbc.gridy = 5; gbc.gridx = 0; gbc.gridwidth = 1; gbc.insets = new Insets(0, 0, 6, 5);
        this.add(lblNivel, gbc);
        gbc.gridx = 1; gbc.insets = new Insets(0, 5, 6, 5);
        this.add(txtNivel, gbc);
        gbc.gridx = 2; gbc.insets = new Insets(0, 5, 6, 5);
        this.add(lblVida, gbc);
        gbc.gridx = 3; gbc.insets = new Insets(0, 5, 6, 0);
        this.add(txtVida, gbc);

        // Atributos (Linha 3) - Defesa e Ataque
        gbc.gridy = 6; gbc.gridx = 0; gbc.insets = new Insets(0, 0, 6, 5);
        ...
        // Atributos (Linha 4) - DT e Raça
        gbc.gridy = 7; gbc.gridx = 0; gbc.insets = new Insets(0, 0, 6, 5);
        this.add(lblDt, gbc);
        gbc.gridx = 1; gbc.insets = new Insets(0, 5, 6, 5);
        this.add(txtDt, gbc);
        gbc.gridx = 2; gbc.insets = new Insets(0, 5, 6, 5);
        ...
        // Separador Loot
        JPanel pnlLoot = new JPanel(new GridBagLayout());
        pnlLoot.setOpaque(false);
        ...
        gbc.gridy = 9; gbc.gridx = 0; gbc.gridwidth = 4; gbc.insets = new Insets(15, 0, 5, 0);
        this.add(pnlLoot, gbc);

        // Tabela Loot
        gbc.gridy = 10; gbc.weighty = 1.0; gbc.fill = GridBagConstraints.BOTH;
        this.add(scrLoot, gbc);

        // Botões Loot
        gbc.gridy = 11; gbc.weighty = 0; gbc.fill = GridBagConstraints.HORIZONTAL; gbc.gridwidth = 2; gbc.insets = new Insets(10, 0, 5, 5);
        this.add(btnAdicionarLoot, gbc);
        gbc.gridx = 2; gbc.insets = new Insets(10, 5, 5, 0);
        this.add(btnRemoverLoot, gbc);

        // Botões Monstro
        gbc.gridy = 12; gbc.gridx = 0; gbc.gridwidth = 2; gbc.insets = new Insets(10, 0, 0, 5);
        this.add(btnSalvar, gbc);
        gbc.gridx = 2; gbc.insets = new Insets(10, 5, 0, 0);
    ...
    private void estilizarComboBox(JComboBox<String> cbx) {
        ...
        cbx.setPreferredSize(new Dimension(0, 28));
